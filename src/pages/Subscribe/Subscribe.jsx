    ...
    <>
      <div className="subscribe bg-black">
        ...
        <form className="flex flex-col gap-8 w-auto mx-[5%] md:w-[500px] md:mx-0">
          ...
          <span className="text-white pb-[30px] md:pb-[70px] text-[14px] font-[#dbd4c5]">By submitting this form, you agree to our <a href="http://www.fluxtechnologiesafrica.com/privacy" className="underline">Privacy Policy.</a></span>
        </form>
        </div>
      </div>
    </>
