...
const CarDesign = () => {
  ...
  return (
    <div className="mt-28 lg:ml-10 px-2 lg:px-0 lg:flex lg:flex-row">
      ...
      <div id="priceSection">result:</div>
      <div
      ...
      <div className="flex flex-col gap-3 lg:px-10 overflow-y-scroll max-h-screen mb-16 lg:w-[22%]">
        ...
        <div className="flex flex-col items-center gap-3 pt-16">
          ...
          <div
            className="form-control justify-between flex-row items-center w-full"
            id="prices"
          >
            <label className="label cursor-pointer gap-2">
              <input
                type="checkbox"
                value="5000"
                className="checkbox border-[#ddc861] rounded custom-checkbox"
              />
          ...
          <div className="form-control justify-between flex-row items-center w-full">
            <label className="label cursor-pointer gap-2">
              <input
                type="checkbox"
                value="5000"
                className="checkbox checkbox-primary border-[#ddc861] rounded custom-checkbox"
              />
        ...
        <div className="flex flex-col items-center gap-3 pt-16">
          ...
          <span className="text-white font-semibold">
            Total Price :<span id="" className="text-[#ddc861]"> ${total}.00</span>
          </span>
          <span className="text-white font-semibold">
